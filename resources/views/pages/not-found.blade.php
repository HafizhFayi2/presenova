@php
    $requestedPath = parse_url(request()->getRequestUri() ?? '', PHP_URL_PATH) ?: '/';
...
<head>
    ...
    <title>{{ (int) ($errorCode ?? 404) }} - presenova</title>
    <meta name="color-scheme" content="light dark">
    <meta name="theme-color" content="#f8fafc" media="(prefers-color-scheme: light)">
    <meta name="theme-color" content="#03010f" media="(prefers-color-scheme: dark)">
    <meta name="robots" content="noindex, nofollow">
    <link rel="apple-touch-icon" href="{{ asset('assets/images/apple-touch-icon_404.png') }}?v=20260212c">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('assets/images/favicon-16x16_404.png') }}?v=20260212c">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('assets/images/favicon-32x32_404.png') }}?v=20260212c">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/images/favicon_404.ico') }}?v=20260212c">
