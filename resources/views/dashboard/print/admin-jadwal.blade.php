...
<body>
    <main class="print-sheet">
        <header class="sheet-header section-keep">
            ...
            <div class="print-meta">
                ...
                <div>
                    <span>Role</span>
                    <strong>{{ $printedRole ?? 'Admin/Operator' }}</strong>
                </div>
            </div>
        </header>
        ...
        <section class="table-section">
            ...
            @if (!empty($schedules))
                <div class="table-wrap">
                    <table class="schedule-table schedule-table-grouped" aria-label="Jadwal Mengajar Admin">
                        <thead>
                            <tr>
                                <th>Hari</th>
                                <th>Jadwal</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="cell-schedule">
                                            ...
                                            <div class="schedule-sub">
                                                <span>{{ (string) ($schedule['teacher_name'] ?? '-') }}</span>
        ...
        <footer class="sheet-footer section-keep">
            ...
            <div>Printed at {{ $printedAt }} by {{ $printedBy }} ({{ $printedRole ?? 'Admin/Operator' }})</div>
        </footer>
    </main>
    ...
    function notifyPdfDownloaded() {
        ...
        const body = 'File PDF jadwal admin/operator berhasil diunduh.';
