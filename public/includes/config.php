...
if (!defined('FACE_MATCH_BACKUP_MODEL')) define('FACE_MATCH_BACKUP_MODEL', (string) legacy_env('LEGACY_FACE_MATCH_BACKUP_MODEL', 'Facenet512'));
if (!defined('FACE_MATCH_BACKUP_DETECTOR')) define('FACE_MATCH_BACKUP_DETECTOR', (string) legacy_env('LEGACY_FACE_MATCH_BACKUP_DETECTOR', 'retinaface'));
if (!defined('FACE_MATCH_BACKUP_MAX_REFERENCES')) define('FACE_MATCH_BACKUP_MAX_REFERENCES', (int) legacy_env('LEGACY_FACE_MATCH_BACKUP_MAX_REFERENCES', 3));
